...
# docker build -t yoezer_hotel .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name yoezer_hotel yoezer_hotel
...
RUN mkdir -p /rails/public/assets && \
    chown -R rails:rails /rails/public/assets
