...
RSpec.describe 'Admin::Offers', type: :request do
  ...
  describe 'GET /index' do
    subject do
      get admin_hotel_offers_path(hotel)
      response
    end
  ...
  describe 'GET /show' do
    context 'when offer exists' do
      subject do
        get admin_hotel_offer_path(hotel, offer)
        response
      end
    ...
    context 'when offer record does not exist' do
      subject do
        get admin_hotel_offer_path(hotel, offer.id + 1)
        response
      end
  ...
  describe 'GET /new' do
    subject do
      get new_admin_hotel_offer_path(hotel)
      response
    end
  ...
  describe 'GET /edit' do
    subject do
      get edit_admin_hotel_offer_path(hotel, offer)
      response
    end
  ...
  describe 'GET /update' do
    context 'with valid params' do
      subject(:update_offer) do
        put admin_hotel_offer_path(hotel, offer), params: { offer: valid_hotel_offer_params }
        response
      end
    ...
    context 'with invalid params' do
      subject(:update_offer) do
        put admin_hotel_offer_path(hotel, offer), params: { offer: invalid_hotel_offer_params }
        response
      end
  ...
  describe 'GET /create' do
    context 'with valid params' do
      subject(:create_offer) do
        post admin_hotel_offers_path(hotel), params: { offer: valid_hotel_offer_params }
        response
      end
    ...
    context 'with invalid params' do
      subject(:create_offer) do
        post admin_hotel_offers_path(hotel), params: { offer: invalid_hotel_offer_params }
        response
      end
  ...
  describe 'GET /destroy' do
    subject(:delete_offer) do
      delete admin_hotel_offer_path(hotel, offer)
      response
    end
