  ...
  describe 'PUT /update' do
    ...
    context 'with valid params' do
      subject(:update_profile) do
        put admin_profile_path(profile, params: { profile: valid_profile_params })
        response
      end
      ...
      it 'updates designation correctly' do
        update_profile
        expect(Profile.last.designation).to eq(valid_profile_params[:designation].to_sym)
      end
    ...
    context 'with invalid params' do
      subject(:update_profile) do
        put admin_profile_path(profile), params: { profile: invalid_profile_params }
        response
      end
